...
export const projects: Project[] = [
  ...
  {
    id: "medical-ai-bachmai",
    title: "Trợ lý AI Y tế cho Quản lý Bệnh viện",
    client: "Vietsens — triển khai tại Bệnh viện Bạch Mai",
    category: "AI / ML",
    summary:
      "Giải pháp AI tích hợp trong Phần mềm Quản lý Bệnh viện Quốc gia, hỗ trợ bác sĩ khai thác bệnh sử và chẩn đoán sơ bộ.",
    highlights: [
      "AI agents tương tác hỗ trợ kê đơn và chẩn đoán",
      "Module phân tích dữ liệu bệnh nhân theo thời gian thực",
      "Tích hợp liền mạch với Hospital Information System hiện có",
    ],
    stack: ["LLMs", "NLP", "Python", "HIS Integration"],
    member: "vuvietanh",
    image: "/team-collab.jpg",
  },
  {
